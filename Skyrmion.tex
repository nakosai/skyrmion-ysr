...
%header for the edition
\begin{figure}
	\centering
	\includegraphics[width=.7\hsize]{nDOS.pdf}
	\caption{\label{fig:nDOS} Spin-resolved density of states obtained by a numerical calculation. }
\end{figure}
...
As we discuss in the main text, the sYSR states are different from the ordinary YSR state in that their wavefunctions decay in a power-law on the spatial coordinate. Figure~\ref{fig:decay} shows the sYSR wavefunction in the log-log scale. One can see the envelope of it linearly decays
\begin{figure}
	\centering
